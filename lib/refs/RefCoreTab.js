...
var propTypes = {
    ...
    chosenText: _propTypes2["default"].string,
    hiddenChosenText: _propTypes2["default"].string,
...
var RefCoreTab = function (_Component) {
    ...
    function RefCoreTab(props) {
        ...
        var language = props.language,
            chosenText = props.chosenText,
            hiddenChosenText = props.hiddenChosenText;
        ...
        if (chosenText) {
            _this.Alreadychosen = chosenText;
        }
        if (hiddenChosenText) {
            _this.Hidechosen = hiddenChosenText;
        }
        return _this;
    }
