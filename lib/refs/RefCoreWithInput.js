...
var getFilterData = function getFilterData(data, valueField, displayField) {
	...
	data.forEach(function (item) {
		...
		filterItems.push(_react2["default"].createElement(FilterItem, { key: values, rowindex: index, text: names, value: values }));
...
var RefCoreWithInput = function (_Component) {
	...
	function RefCoreWithInput(props) {
		...
		_this.onClickFilterItem = function (e) {
			...
			var filterDataItem = filterData[dataset.rowindex];
		...
		_this.selectOnchange = function (value, e) {
			console.log('122', e, value);
			_this.onClickFilterItem(e);
		};
			...
			if (filterData.length) {
				filterData.forEach(function (item, index) {
					...
					children.push(_react2["default"].createElement(
						Option,
						{ value: values, dataset: { value: values, type: 'filteritem', rowindex: index } },
						names
					));
				});
				return children;
  ...
  */
	...
	RefCoreWithInput.prototype.render = function render() {
		...
		var _props2 = this.props,
		    ...
		    notFoundContent = _props2$notFoundConte === undefined ? '没有匹配到数据' : _props2$notFoundConte,
		...
		return _react2["default"].createElement(
			'div',
			{ className: 'ref-input-wrap ref-core-with-inupt ' + wrapClassName + ' ' + theme,
			...
			_react2["default"].createElement(
				...
				checkedArray.length && clearBut ? _react2["default"].createElement(
					...
					_react2["default"].createElement(
						'span',
						{ className: 'uf uf-close-c ' + (disabled ? 'ref-input-wrap-display' : '') },
						' '
					)
				) : '',
				_react2["default"].createElement(
