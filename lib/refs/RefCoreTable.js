  ...
  RefCoreTable.prototype.renderColumnsMultiSelect = function renderColumnsMultiSelect(columns) {
    ...
    if (!this.props.multiple) {
      if (multiSelect && multiSelect.type === "checkbox") {
        ...
        var defaultColumns = [{
          title: _react2["default"].createElement(_nextUi.Checkbox, {
          ...
          render: function render(text, record, index) {
            return _react2["default"].createElement(_nextUi.Checkbox, {
              className: 'table-checkbox',
  ...
  RefCoreTable.prototype.render = function render() {
    ...
    return _react2["default"].createElement(
      ...
      _react2["default"].createElement(
        ...
        _react2["default"].createElement(_nextUi.Table, _extends({}, option, { ref: function ref(el) {
