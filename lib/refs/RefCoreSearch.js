	...
	RefCoreSearch.prototype.render = function render() {
		...
		return _react2["default"].createElement(
			...
			_react2["default"].createElement(
				_nextUi.InputGroup.Button,
				{ shape: 'border', onClick: this.onSearch.bind(this), fieldid: this.getFieldid('btn') },
				_react2["default"].createElement(
					'span',
					{ className: 'uf uf-search', fieldid: this.getFieldid('btn_search') },
					' '
				)
			)
		);
